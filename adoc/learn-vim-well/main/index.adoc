...
[NOTE]
====
Emacs uses have been doing this forever. So much so that they ultimately decided to create an OS within an OS that essentially is one big Lisp interpreter. Vim is not Emacs.
====
